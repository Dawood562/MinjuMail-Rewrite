...
client = commands.Bot(command_prefix = '_', help_command=None, intents=intents, allowed_mentions = discord.AllowedMentions(everyone = False, roles = False), strip_after_prefix=True)
...
# --Load cogs--
cogs = ["acceptreject", "Admin Commands", "help", "report", "suggest", "testcmds", "tickets"]
